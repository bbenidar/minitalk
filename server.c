...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/28 16:21:30 by bbenidar          #+#    #+#             */
/*   Updated: 2023/04/11 23:44:30 by bbenidar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minitalk.h"

void	print_caract(int *received_bits, char *received_message)
{
...
void	handle_signal(int signal, siginfo_t *info, void *context)
{
	...
	if (signal == SIGUSR1)
	{
		...
		received_bits++;
	print_caract(&received_bits, &received_message);
}
